...
#ifndef _gamertipRPC_H_
#define _gamertipRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // gamertip is not connected
...
/**
 * gamertip RPC command dispatcher.
 */
class CRPCTable
{
private:
